...
const SystemHealth = struct {
    ...
    pub const summary = "Checks system health.";
    pub const description = "Check if the system is healthy.";
...
const UserList = struct {
    ...
    pub const summary = "Get user list.";
    pub const Request = struct {
        pub const Params = struct {};
...
const UserCreate = struct {
    ...
    pub const tags = .{"users"};
    pub const description = "Description for creating users.";
    pub const Request = struct {
        pub const Params = struct {};
        pub const Query = struct {};
